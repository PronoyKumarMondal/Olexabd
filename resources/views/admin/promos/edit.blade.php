            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.promos.update', $promo) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 {{ $promo->type == 'percent' ? '' : 'd-none' }}" id="maxDiscountDiv">
                            <label class="form-label">Max Discount (Upto)</label>
                            <div class="input-group">
                                <span class="input-group-text">Upto ৳</span>
                                <input type="number" name="max_discount_amount" class="form-control" value="{{ $promo->max_discount_amount }}" step="0.01" placeholder="Max Discount">
                            </div>
                        </div>
                    </div>
